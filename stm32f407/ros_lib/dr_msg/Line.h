#ifndef _ROS_dr_msg_Line_h
#define _ROS_dr_msg_Line_h

#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"
#include "dr_msg/Point.h"
...
namespace dr_msg
{
  ...
  class Line : public ros::Msg
  {
    public:
      ...
      typedef dr_msg::Point _points_type;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      if(points_lengthT > points_length)
        this->points = (dr_msg::Point*)realloc(this->points, points_lengthT * sizeof(dr_msg::Point));
      points_length = points_lengthT;
      for( uint32_t i = 0; i < points_length; i++){
      offset += this->st_points.deserialize(inbuffer + offset);
        memcpy( &(this->points[i]), &(this->st_points), sizeof(dr_msg::Point));
      }
     return offset;
    }

    const char * getType(){ return "dr_msg/Line"; };
