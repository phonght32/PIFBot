#ifndef _ROS_pcl_msg_YoloPredict_h
#define _ROS_pcl_msg_YoloPredict_h
...
namespace pcl_msg
{
  ...
  class YoloPredict : public ros::Msg
  {
    public:
      ...
      _header_type header;
      typedef pcl_msg::Rect2d _bbox_type;
      _bbox_type bbox;
    ...
    const char * getType(){ return "pcl_msg/YoloPredict"; };
