...
#include <std_msgs/UInt16.h>
 void led_cb( const std_msgs::UInt16& cmd_msg){  } ros::NodeHandle nh; std_msgs::String str_msg; ros::Publisher chatter("chatter", &str_msg); ros::Subscriber<std_msgs::UInt16> sub("led", led_cb);
...
int main(void)
{
  ...
  /* USER CODE END 2 */
//  HAL_UART_Transmit_DMA(&huart4,data_send,9);
  /* Infinite loop */
