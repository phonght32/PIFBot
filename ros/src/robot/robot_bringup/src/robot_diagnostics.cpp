...
#include <robot_msgs/SensorState.h>
#include <robot_msgs/VersionInfo.h>
#include <string>
...
void sensorStateMsgCallback(const robot_msgs::SensorState::ConstPtr &msg)
{
  if (msg->battery > 11.0)
  ...
  if (msg->button == robot_msgs::SensorState::BUTTON0)
    setButtonDiagnosis(diagnostic_msgs::DiagnosticStatus::OK, "BUTTON 0 IS PUSHED");
  else if (msg->button == robot_msgs::SensorState::BUTTON1)
...
void firmwareVersionMsgCallback(const robot_msgs::VersionInfo::ConstPtr &msg)
{
  ...
  robot_msgs::VersionInfo version;
...
int main(int argc, char **argv)
{
  ...
  tb3_version_info_pub = nh.advertise<robot_msgs::VersionInfo>("version_info", 10);
